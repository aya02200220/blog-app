...
const Post = ({ _id, title, summary, cover, content, createdAt, author }) => {
  return (
        ...
        <Link to={`/post/${_id}`}>
          <div className={cardStyle.card}>
            ...
            <div className={cardStyle.text}>
              <p className={cardStyle.h3}> Meeting your Colleagues </p>
              <p className={cardStyle.p}> 6 Video - 40 min </p>

              <div className={cardStyle.icon_box}>
                <svg
                  version="1.1"
                  className={cardStyle.svg}
                  id="Capa_1"
	...
	C442.01,116.493,444.197,117.371,446.539,117.17z"
                ...
                <p className={cardStyle.span}>Business Trip</p>
              </div>
            </div>
          </div>
        </Link>
